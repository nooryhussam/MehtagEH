...
//                                 .validate();
//                             final isImageValid = _selectedImagePath != null;
...
//                                   nationalIdText: _natinalcontroller.text
//                                       .trim(),
                    ...
                    builder: (context, idState) {
                      return Stack(
                        children: [
                              ...
                              children: [
                                ...
                                AppButton(
                                  ...
                                  onTap: () {
                                    ...
                                    // ── ابدأ الـ verification، لو نجحت الـ listener هيعمل signup تلقائي ──
                          ...
                          // ── Loading overlay (shown during verification OR signup) ──
